      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            { step: "2", title: "ลงทะเบียนด้วยรหัสโรงเรียน", desc: "ระบบดึงชื่อโรงเรียน เขต และจังหวัดให้อัตโนมัติ แล้วสร้างบัญชีเข้าพอร์ทัล" },
            { step: "3", title: "เรียนจากวิดีโอ", desc: "รับชมบทเรียน ICT ให้ครบ เพื่อปลดล็อกสิทธิ์เข้าสอบ" },
            { step: "4", title: "สอบคัดเลือก", desc: "ตอบข้อสอบแบบบันทึกฉบับร่างได้ จนกว่าจะส่งคำตอบสุดท้าย" },
          ].map((item) => (
            <div key={item.step} className="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-3">
