...
export default function AdminLoginPage() {
  const { loginAdmin, session, hydrated } = useIctStore();
    ...
    <div className="max-w-md mx-auto px-4 py-16 animate-fade-in-up">
      <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-[var(--primary-blue)] mb-2">Password</label>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          <Link href="/" className="text-[var(--primary-blue)] font-semibold">
            กลับหน้าหลัก
          </Link>
        </p>
      </form>
